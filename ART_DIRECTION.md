...
- Blue Grotto Pup's ultra form has a wide cannon cluster, so its board sprite should stay slightly left-biased and compact enough that neighboring defenders remain readable. Do not let the ultra cannons visually swallow a defender placed immediately to the right.
...
- Level 2 / Dragon Boat Lagoon uses two water lanes with compact Dragon Boat Platforms as a separate support layer. The boats should read as festive Dragon Boat Festival platforms, not full racing boats, and defenders stand on top without losing their own silhouette.
